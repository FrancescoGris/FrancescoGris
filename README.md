...
> Desenvolvedor Fullstack · Campo Mourão, Paraná 🇧🇷

---

## Sobre mim
Sou desenvolvedor fullstack com experiência prática em projetos web reais, do front ao back, incluindo containerização e testes automatizados. Trabalho com **React, Node.js, Express, MySQL, Prisma, Docker e Playwright**, construindo aplicações completas, escaláveis e prontas para produção.
...
### Pedaço de Céu
Projeto fullstack completo, do desenvolvimento ao deploy: **React, Node.js, MySQL, Docker, Nginx, TypeScript e testes automatizados com Playwright**. Construído com foco em boas práticas de arquitetura e qualidade de código.
`React` `Node.js` `MySQL` `Docker` `Nginx` `TypeScript` `Playwright`

<!-- Adicione aqui outros projetos fixados, no mesmo formato:
### Nome do Projeto
